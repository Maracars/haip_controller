...
system/startup_ldf/Debug/%.doj: ../system/startup_ldf/Debug/%.asm
	...
	easmblkfn.exe -file-attr ProjectName="AudioLoopback" -proc ADSP-BF537 -si-revision any -g -D_DEBUG -i"E:\ander\Desktop\Clase\POPBL5\WS_EJEMPLO\AudioLoopback\system" -i"E:/Analog Devices/ADSP-BF537_EZKIT-Rel1.0.0/BF537_EZ-KIT_Lite/Blackfin/include" -gnu-style-dependencies -MM -Mo "system/startup_ldf/Debug/AudioLoopback.dxe.d" -o "$@" "$<"
