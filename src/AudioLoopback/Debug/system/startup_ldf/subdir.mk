...
system/startup_ldf/%.doj: ../system/startup_ldf/%.s
	...
	easmblkfn.exe -file-attr ProjectName="AudioLoopback" -proc ADSP-BF537 -si-revision any -g -D_DEBUG -i"E:\ander\Desktop\Clase\POPBL5\haip_controller\src\AudioLoopback\system" -i"/Blackfin/include" -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
